...
class MySignal extends StatefulWidget {
  const MySignal({Key key}) : super(key: key);

  @override
  _MySignalState createState() => _MySignalState();
}

class _MySignalState extends State<MySignal> {
